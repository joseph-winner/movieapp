...
$(document).ready(function() {
    ...
    $.each(s, function(p, s) {
        ...
        var e = s.parent()
          , x = t;
        x.prevPage = e.find(".btn-prev"),
        x.nextPage = e.find(".btn-next"),
        s.sly(x)
    }),
    ...
    return function s(o, t) {
        function e(p, s, e) {
            if ("undefined" != typeof document) {
                "number" == typeof (e = i({}, t, e)).expires && (e.expires = new Date(Date.now() + 864e5 * e.expires)),
        ...
        return Object.create({
            ...
            withAttributes: function(p) {
                return s(this.converter, i({}, this.attributes, p))
            },
            withConverter: function(p) {
                return s(i({}, this.converter, p), this.attributes)
            }
        }, {
            attributes: {
